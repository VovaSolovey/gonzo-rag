...
11. Если в контексте несколько постов про разные статьи — отвечай по каждому ОТДЕЛЬНО, не смешивая информацию. Используй заголовок каждого поста как разделитель.
